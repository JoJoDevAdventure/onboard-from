...
const DesignerWorkView = ({ onNext }) => {
  ...
  return (
    ...
    >
      <h1 className="text-[72px] text-[#F6D31F] mb-4">Our Designers Work</h1>
      <Carousel />
      <div className="flex flex-row justify-center items-center mt-4 gap-4">
        ...
        <motion.div
          ...
          whileTap={{ scale: 0.8 }}
          className="bg-[#F6D31F] text-[#9B4191] rounded-full w-16 h-16 flex items-center justify-center cursor-pointer"
        ...
        <CustomButton
          ...
          text={"Submit"}
          className="bg-[#F6D31F] py-4 px-6 w-[30%] text-[#9B4191] rounded-full"
        />
      </div>
    </motion.div>
  );
